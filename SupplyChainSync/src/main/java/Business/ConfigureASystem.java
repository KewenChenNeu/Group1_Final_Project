...
/**
 * Enhanced System Configuration with Java Faker Generates comprehensive test
 * data for all enterprises, especially for Distributor Enterprise testing
 *
 * @author chris
 */
public class ConfigureASystem {
    ...
    private static void createSampleWorkRequests(
        ...
        // Sample RM Restock Request #2 (Pending)
        RawMaterialRestockRequest rmRequest2 = new RawMaterialRestockRequest();
        rmRequest2.setMaterialName("Copper Wire");
        rmRequest2.setQuantity(300);
        rmRequest2.setUnit("kg");
        rmRequest2.setUnitPrice(3.25);
        rmRequest2.setUrgencyLevel("Urgent");
        rmRequest2.setMessage("Production backup needed");
        rmRequest2.setStatus("Pending");   // intentionally pending
        rmProcurementOrg.getWorkQueue().addWorkRequest(rmRequest2);

        // Sample RM Restock Request #3 (Approved already)
        RawMaterialRestockRequest rmRequest3 = new RawMaterialRestockRequest();
        rmRequest3.setMaterialName("Plastic Pellets");
        rmRequest3.setQuantity(200);
        rmRequest3.setUnit("kg");
        rmRequest3.setUnitPrice(1.75);
        rmRequest3.setUrgencyLevel("Normal");
        rmRequest3.setMessage("Stock levels maintained");
        rmRequest3.setStatus("Approved");   // already approved
        rmProcurementOrg.getWorkQueue().addWorkRequest(rmRequest3);
    ...
    /**
     * ============================================================ ENHANCED
     * TEST DATA GENERATION WITH JAVA FAKER For comprehensive Distributor
     * Enterprise testing
     * ============================================================
     */
