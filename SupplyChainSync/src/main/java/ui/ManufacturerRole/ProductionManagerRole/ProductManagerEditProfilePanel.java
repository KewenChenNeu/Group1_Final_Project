 ...
 * @author chris
 */
public class ProductManagerEditProfilePanel extends javax.swing.JPanel {
    
    private JPanel userProcessContainer;
    private UserAccount userAccount;
    private ProductionManagementOrganization organization;
     ...
     */
    public ProductManagerEditProfilePanel(JPanel userProcessContainer, UserAccount account, ProductionManagementOrganization productionManagementOrganization, Enterprise enterprise, EcoSystem system) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.organization = productionManagementOrganization;
